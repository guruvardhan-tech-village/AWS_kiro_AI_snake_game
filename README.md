...
Play the Snake Game directly in your browser — **no installation required**:

👉 **[Play Live on GitHub Pages](https://guruvardhan-tech-village.github.io/AWS_kiro_AI_snake_game/)**

🧪 Run the full automated test suite here:  
👉 **[Run Tests](https://guruvardhan-tech-village.github.io/AWS_kiro_AI_snake_game/final-test.html)**

> 🤖 Toggle **AI Mode** in the game to watch the intelligent controller play autonomously.
